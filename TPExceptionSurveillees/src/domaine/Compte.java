...
public class Compte {
	...
	/**
	 * méthode de retrait dans un compte
	 * @param mt montant à retirer
	 * @throws MontantNegatifException gère les montants négatifs à retirer 
	 * @throws SoldeInsuffisantException  gère le solde insuffisant
	 */
	public void retirer(double mt) throws MontantNegatifException, SoldeInsuffisantException {
		if(mt<0) throw new MontantNegatifException("Montant retiré négatif");
	 ...
	 * @throws MontantNegatifException gère le solde insuffisant
	 * 
	 */
	public void verser(double mt) throws MontantNegatifException{
		if(mt<0) throw new MontantNegatifException("Montant versé négatif");
		solde += mt;
	}
